...
const getInitialMockSettings = (): AppSettings => {
  const defaultSettings: AppSettings = {
    ...
    formFields: [
       ...
       { id: "NIK", label: "NIK", type: "number", maxLength: 16, pattern="[0-9]{16}", required> },
       ...
       { id: "NIK Ayah", label: "NIK Ayah", type: "number", maxLength: 16, pattern="[0-9]{16}", required> },
       { id: "Tanggal Lahir Ayah", label: "Tanggal Lahir Ayah", type: "date", required: true },
       { id: "Nama Ibu", label: "Nama Ibu", type: "text", required: true },
       { id: "NIK Ibu", label: "NIK Ibu", type: "number", maxLength: 16, pattern="[0-9]{16}", required> },
